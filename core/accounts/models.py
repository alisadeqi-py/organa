...
class User(AbstractUser):
    phonenumber = models.CharField(max_length=11,validators=[RegexValidator(r'09(1[0-9]|3[0-9]|2[0-9])-?[0-9]{3}-?[0-9]{4}')] , unique=True)
    ...
    REQUIRED_FIELDS = ['phonenumber' , 'address' , 'city' , 'zip_code' , 'email']
